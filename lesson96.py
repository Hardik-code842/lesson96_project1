...
page_dicts = {"Home":home,"View Data":data,"Visualise Data":plots,"Predict":predict}
# Add radio buttons in the sidebar for navigation and call the respective pages based on 'user_choice'.
st.sidebar.title("Navigation")
choice = st.sidebar.radio("Go to ",tuple(page_dicts.keys()))
if choice == "Home":
  home.app()
else:
  selected_page = page_dicts[choice]
  selected_page.app(final_car_df)